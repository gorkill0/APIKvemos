 ...
 * Series con la media más alta, muestra 10 resultados
 * La anotación @Immutable indica que no se puede mostrar
 * La anotación @Subselect indica la vista
 */
@Entity
@Immutable
@Subselect("SELECT * FROM vista_mejores_series")
public class SeriesMedia implements Serializable {
     ...
     * @param media 
     */
    public SeriesMedia(Integer id, String titulo, Float media) {
        this.id = id;
        this.titulo = titulo;
        this.media = media;
    }
